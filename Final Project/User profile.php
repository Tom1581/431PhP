...
<body>
  <div class="main-content">
            ...
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="media align-items-center">
                <span class="avatar avatar-sm rounded-circle">
                  <img alt="Image placeholder" src="profile1.jpg">
                </span>
                <div class="media-body ml-2 d-none d-lg-block">
                  <span class="mb-0 text-sm  font-weight-bold">User's Name</span>
                </div>
              </div>
            </a>
    ...
    <!-- Header -->
    <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 600px; background-image: url(P123.jpg); background-size: cover; background-position: center top;">
      <!-- Mask -->
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white">Hello Dear User  </h1>
            <p class="text-white mt-0 mb-5">This is your Medlinked work platform, you can build your connections with the suppliers</p>
          ...
          <div class="card card-profile shadow">
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="profile1.jpg" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                <h3>
                User's Name<span class="font-weight-light"> </span>
                </h3>
                ...
                <div>
                  <i class="ni education_hat mr-2"></i>Medical Doctor 
                </div>
                <hr class="my-4">
                <p>Has been work at hospital in San Jose,CA</p>
                <a href="#">Show more</a>
              </div>
            </div>
          </div>
              ...
              <form>
                ...
                <div class="pl-lg-4">
                  <div class="form-group focused">
                    ...
                    <textarea rows="4" class="form-control form-control-alternative" placeholder="A few words about you ...">comments </textarea>
                    <br><br>
  ...
  <footer class="footer">
    <div class="row align-items-center justify-content-xl-between">
      <div class="col-xl-6 m-auto text-center">
        <div class="copyright">
          <p>Made with <a href="https://www.creative-tim.com/product/argon-dashboard" target="_blank">CSUF</a> by Creative Project
         </p>
        </div>
      </div>
    </div>
